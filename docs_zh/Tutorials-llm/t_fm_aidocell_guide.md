...
为无监督细胞聚类优化的稠密 Transformer，无需预定义标签

!!! tip "何时选择 AIDO.Cell"

    适用于需要无监督聚类、无标签细胞分组或用于发现任务的稠密 Transformer 嵌入的场景
...
| 键 | 位置 | 描述 |
|-----|----------|-------------|
| `X_aidocell` | `adata.obsm` | 细胞嵌入向量（512 维） |
...
- **仓库 / 检查点：** [https://github.com/genbio-ai/AIDO](https://github.com/genbio-ai/AIDO)
- **许可证：** 请查阅上游 LICENSE
...
如需包含代码的逐步演练，请参阅 [AIDO.Cell 教程笔记本](t_fm_aidocell.ipynb)。
