...
| 键 | 位置 | 描述 |
|-----|----------|-------------|
| `X_cellfm` | `adata.obsm` | 细胞嵌入向量（512 维） |
...
- **仓库 / 检查点：** [https://github.com/cellverse/CellFM](https://github.com/cellverse/CellFM)
- **许可证：** 请查阅上游 LICENSE
...
如需包含代码的逐步演练，请参阅 [CellFM 教程笔记本](t_fm_cellfm.ipynb)。
